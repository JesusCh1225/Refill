    ...
    <div className="min-h-screen bg-surface-page flex flex-col">
      ...
      >
        ...
        <Section title="1. 수집하는 개인정보 항목">
          <p className="mb-2">
            서비스는 소셜 로그인(Google·카카오·네이버)을 통해 아래 정보를 수집합니다.
          </p>
        ...
        <Section title="5. 개인정보 처리 위탁">
          ...
          <table className="w-full text-[12px] border border-border-card rounded-lg overflow-hidden mt-3">
            ...
            <tbody className="divide-y divide-border-card">
              ...
              <tr>
                ...
                <td className="px-3 py-2">소셜 로그인 인증 (미국 소재, 국외 이전)</td>
              </tr>
              <tr>
          ...
          <p className="mt-3 text-text-muted">
            Google LLC는 미국에 서버를 두고 있으며, 로그인 인증 과정에서 수집된
            정보가 국외로 이전될 수 있습니다. Google의 개인정보 처리방침은{" "}
            <a
